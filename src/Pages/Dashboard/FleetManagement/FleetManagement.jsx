...
//         setEditPanel(null); // Hide panel after successful update
//         refetch(); // Refresh data
//         // Show the panel again after successful update
//         setTimeout(() => {
...
//               {text}
//             </span>
//             {/* Show edit button only on row hover */}
//             {hoveredRow === vehicleId && (
//               <div
//                 className="bg-gray-300 rounded-full h-3 w-3 hover:bg-sky-500 transition-all duration-150 ease-in-out cursor-pointer"
//                 onClick={() => handleEditPanelToggle(vehicleId)}
//               ></div>
//             )}
//             {/* Show status edit panel */}
//             {isEditPanelOpen && (
//               <motion.div className="flex gap-1.5 items-center justify-center border rounded-full p-1 bg-white">
//                 {availableOptions.map((option) => (
//                   <div
//                     key={option.key}
//                     className="h-3 w-3 rounded-full cursor-pointer hover:scale-110 transition-transform duration-150"
