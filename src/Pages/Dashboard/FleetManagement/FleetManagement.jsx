...
//       return (
//         (licensePlate && licensePlate.toLowerCase().includes(lowerQuery)) ||
//         (carModel && carModel.toLowerCase().includes(lowerQuery)) ||
//         (carType && carType.toLowerCase().includes(lowerQuery)) ||
//         (fuelType && fuelType.toLowerCase().includes(lowerQuery)) ||
//         (dailyRate && dailyRate.toLowerCase().includes(lowerQuery)) ||
//         (lastMaintenanceDate &&
//           lastMaintenanceDate.toLowerCase().includes(lowerQuery))
//       );
//     }
//   );
