...
//   // Validate form fields when isClicked changes
//   useEffect(() => {
//     if (isClicked) {
//       validateStepOne();
//     }
...
//       if (!pickupDateTime) {
//         errors.pickupTime = "Pickup date and time is required";
//       }

//       if (!returnDateTime) {
//         errors.returnTime = "Return date and time is required";
//       }
...
//       // Validate time logic
//       if (pickupDateTime && returnDateTime) {
//         const pickup = dayjs(pickupDateTime);
...
//         } else if (returnTime.diff(pickup, "hour") < 3) {
//           errors.returnTime = "Minimum rental period is 3 hours";
//         }
//       }
...
//       }
//     } catch (error) {
//       console.error("Step One validation failed:", error);
//       setHasError(true);
//     }
//   };
...
//       if (validationErrors?.pickupTime || validationErrors?.returnTime) {
...
//       // Clear validation error for return time
//       if (validationErrors?.returnTime) {
//         const newErrors = { ...validationErrors };
//         delete newErrors.returnTime;
//         setValidationErrors(newErrors);
//       }
...
//     // Clear validation error for return location
//     if (validationErrors?.returnLocation) {
//       const newErrors = { ...validationErrors };
...
//               },
//             ]}
//             validateStatus={validationErrors?.pickupTime ? "error" : ""}
//             help={validationErrors?.pickupTime}
//           >
//             <DateTimePicker
//               value={pickupDateTime}
//               onChange={handlePickupTimeChange}
...
//               },
//             ]}
//             validateStatus={validationErrors?.returnTime ? "error" : ""}
//             help={validationErrors?.returnTime}
//           >
//             <DateTimePicker
//               value={returnDateTime}
//               onChange={handleReturnTimeChange}
...
//               { required: true, message: "Please select pickup location!" },
//             ]}
//             validateStatus={validationErrors?.pickupLocation ? "error" : ""}
//             help={validationErrors?.pickupLocation}
//           >
//             <Select
//               placeholder="Select pick-up location"
//               className="h-10 w-full"
...
//               { required: true, message: "Please select return location!" },
//             ]}
//             validateStatus={validationErrors?.returnLocation ? "error" : ""}
//             help={validationErrors?.returnLocation}
//           >
//             <Select
//               placeholder="Select return location"
//               className="h-10 w-full"
